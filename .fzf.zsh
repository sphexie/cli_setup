...
bindkey -rM emacs '^T' fzf-file-widget
bindkey -rM vicmd '^T' fzf-file-widget
bindkey -rM viins '^T' fzf-file-widget
bindkey -rM emacs '\ec' fzf-cd-widget
bindkey -rM vicmd '\ec' fzf-cd-widget
bindkey -rM viins '\ec' fzf-cd-widget
